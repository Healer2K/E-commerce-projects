        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前咋们路由跳转是从a路由跳转到b路由，这里在加入购物车进行路由跳转之前，发请求
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //加入购物车的回调函数
      async addShopcar(){
        // 发请求--将产品加入到数据库（通知服务器）派发actions 
        /* 
          当前这里是派发一个actions，也向服务器发请求，判断加入购物车是否成功，并做出相应的操作
        */
        try {
